...
export class ProductCategoryState {
  ...
  fetchProductCategoryList(
    ...
    return this.productCategoryCtrlSvc
      ...
      .pipe(
        tap(response => {
          ctx.dispatch([
            new SetProductCategoryList(response.categories),
            new UpdateProductCategoryPaginateTotal(response.meta.totalCount)
          ]);
        }),
        catchError((error) => {
          console.error(error);
          this.alertSvc.setAlert(AlertType.ERROR, 
                                 LocaleKeys.alerts.failed.category.listFetchFailed);
          return EMPTY;
        }),
        finalize(() => {
          this.uiStateSvc.setLoading(StateKey.PRODUCT_CATEGORY_UI, 
      ...
      .pipe(
        tap(response => {
          ...
          ctx.patchState({
            ...
            list: [...state.list, response.category],
            paginate: {
              ...state.paginate,
          ...
          this.alertSvc.setAlert(AlertType.SUCCESS, 
                                 LocaleKeys.alerts.success.category.created);
        }),
        catchError((error) => {
          console.error(error);
          this.alertSvc.setAlert(AlertType.ERROR, 
                                 LocaleKeys.alerts.failed.category.creationFailed);
    ...
    return this.productCategoryCtrlSvc.update(action.payload)
      .pipe(
        tap(response => {
          ...
          this.alertSvc.setAlert(AlertType.SUCCESS, 
                                 LocaleKeys.alerts.success.category.updated);
        }),
        catchError((error) => {
          console.error(error);
          this.alertSvc.setAlert(AlertType.ERROR, 
                                 LocaleKeys.alerts.failed.category.updateFailed);
          return throwError(() => error);
        }),
        finalize(() => {
          this.uiStateSvc.setProcessing(StateKey.PRODUCT_CATEGORY_UI, 
    ...
    return this.productCategoryCtrlSvc.deleteById(action.id)
      .pipe(
        tap(_ => {
          ...
          this.alertSvc.setAlert(AlertType.SUCCESS, 
                                 LocaleKeys.alerts.success.category.deleted);
        }),
        catchError((error) => {
          console.error(error);
          this.alertSvc.setAlert(AlertType.ERROR, 
                                 LocaleKeys.alerts.failed.category.deletionFailed);
          return throwError(() => error);
        }),
        finalize(() => {
  ...
  checkProductCategoryDeletable(
    ...
    return this.productCategoryCtrlSvc.checkDeletable(action.id)
      .pipe(
        tap(deletableResponse => {
          ctx.dispatch(new SetDeletableResponse(deletableResponse.category));
        }),
        catchError((error) => {
          console.error(error);
          this.alertSvc.setAlert(AlertType.ERROR, 
    ...
    return this.productCategoryCtrlSvc.fetchById(action.id)
      .pipe(
        ...
        catchError((error) => {
          console.error(error);
          this.alertSvc.setAlert(AlertType.ERROR, 
                                 LocaleKeys.alerts.failed.category.fetchFailed);
          return EMPTY;
        }),
        finalize(() => {
          this.uiStateSvc.setProcessing(StateKey.PRODUCT_CATEGORY_UI, 
